...
7. <img src="./image/9-2.png" width="600">B
...
1. 思维模式：**嵌入式 SQL** 使用 **游标** 执行 SQL， **ODBC** 使用 **句柄** 执行 SQL，而 **JDBC** 使用 **语句对象** 执行 SQL。<img src="./image/odbcjbjdbcdxqrsyb.png" width="600">
...
4. 使用FOR UPDATE子句表示既能通过游标更新表数据，也能删除表数据。<img src="./image/for-update.png)
5. 并发执行的多个事务之间可能互相影响，但不需要程序员考虑，而是需要DBMS予以保证
